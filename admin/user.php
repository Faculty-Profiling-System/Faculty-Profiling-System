...
<body>
  <div class="header">
    ...
    <div class="navigation" id="menu">
      ...
      <nav>
        <ul>
          <li><a href="home.php"><img src="../images/home.png" class="menu-icon">HOME</a></li>
          <li><a href="department.php"><img src="../images/department.png" class="menu-icon">COLLEGE MANAGEMENT</a></li>
          <li><a href="user.php" class="active"><img src="../images/user.png" class="menu-icon">USER MANAGEMENT</a></li>
          <li><a href="reports.php"><img src="../images/reports.png" class="menu-icon">REPORTS</a></li>
          <li><a href="setting.php"><img src="../images/setting.png" class="menu-icon">SETTINGS</a></li>
        </ul>
      </nav>
